...
TRMTEMRA_TFs<- ClusterCompare(GDTlung_s, 'gd_TEMRA_P4', 'gd_TRM_P6', features = TFs_gd)
...
F4 <- (PG(list(F4ABC,F4DEF), nrow = 2, greed = F) +
...
F5A <-  ggplot(data_long, aes(x = Var1, y = Var2, fill = value)) +
  ...
  ggtitle('Morisita index of TRD TCRs') 
